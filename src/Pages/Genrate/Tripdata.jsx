        ...
        {Object.keys(TripPlan).length > 0 ? (
          <>
            <div className=" p-4 xl:p-40">
              <img
                src="https://th.bing.com/th/id/OIP.YfEWxvP3vo59bzzbXkY41AHaE8?rs=1&pid=ImgDetMain"
                alt=""
                ...
                <div key={i} className=" m-3 justify-center   ">
                  ...
                  <section className="grid  grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                    {data.schedule.map((data, i) => (
                      <div
                        key={i}
                        className="flex     bg-white rounded-xl  justify-between items-center    mt-[15px] sm:m-4"
                      >
                        <img
                          src="https://www.planetware.com/wpimages/2019/11/india-best-places-to-visit-agra.jpg"
                          alt=""
                          className="sm:w-[250px] sm:h-[200px] w-[150px] h-[100px] object-cover rounded-xl"
                        />
                        <div>
                          ...
                          <p className="text-[13px]  md:text-[15px]">{` " ${data.details}"`}</p>
                        </div>
                      </div>
                    ))}
                  </section>
